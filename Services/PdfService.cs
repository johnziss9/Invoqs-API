    ...
    private void ComposeHeader(IContainer container)
    {
        container.Row(row =>
        {
            row.RelativeItem(2).Column(column =>
            {
                ...
                column.Item().Text("VAT: CY60172438U").FontSize(9);
            });
    ...
    private void ComposeContent(IContainer container, InvoiceDTO invoice)
    {
        container.PaddingVertical(20).Column(column =>
        {
            ...
            column.Item().PaddingTop(20).Column(termsColumn =>
            {
                ...
                termsColumn.Item().Text("Αριθμός Λογαριασμού: 349-01-H99370-01").FontSize(9);
            });
        });
    }
    ...
    private void ComposeReceiptHeader(IContainer container)
    {
        container.Row(row =>
        {
            row.RelativeItem().Column(column =>
            {
                ...
                column.Item().Text("VAT: CY60172438U").FontSize(8);
            });
        });
    }
